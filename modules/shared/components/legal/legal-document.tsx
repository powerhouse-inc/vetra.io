      ...
      <article className="mx-auto max-w-3xl space-y-8">
        ...
        <div className="text-muted-foreground space-y-3 text-sm leading-relaxed">
          <p>
            ...
            (&ldquo;Achra&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;) hosts the
            following domain websites (collectively, the &ldquo;Sites&rdquo;):
          </p>
        ...
        <Section title="1. Achra’s Dual Role and Operating Model">
          ...
          <p>
            ...
            resolution. Marketplace transactions are subject to a 10% commission fee (or as otherwise
            defined in your specific service plan).
          </p>
          <p>
            ...
            specific Operational Hub (OH) products. In this capacity, Achra assumes standard merchant
            liability governed by applicable Service Level Agreements (SLAs) and charges fees via
            subscriptions or fixed pricing.
          </p>
        </Section>
        ...
        <Section title="2. Description of Services">
          ...
          <p>
            ...
            provide software and technical infrastructure to support the setup and operation of legal
            entities. The platform enables clients to access, engage, and contract with independent
            third-party service providers (e.g., legal counsel, accountants, payment providers) and
            to utilize standardized templates for entity setup.
          </p>
          <p>
        ...
        <Section title="3. Account Creation and Onboarding">
          <p>
            ...
            which may include identity, compliance, or regulatory verification processes (KYC/KYB) as
          ...
          <p>
            ...
            trial account with limited functionality or upgrade to a paid subscription by configuring
            services and entering payment details.
          </p>
          <p>
            <strong className="text-foreground">Operational Hub Onboarding:</strong> Users
            authenticate, access the admin panel, and select a product tier. Operational services are
            charged via an existing subscription framework, which includes a fixed monthly fee plus
        ...
        <Section title="4. Eligibility">
          <p>
            ...
            If acting on behalf of an entity, you warrant that you are authorized to bind that entity.
            You represent and warrant that you:
          </p>
          <ul className="list-disc space-y-1 pl-6">
            <li>Are not subject to personal sanctions issued by the UN, US, EU, UK, or Switzerland.</li>
            <li>Access the Services for legitimate business purposes only.</li>
            <li>
              Are not accessing the Services from a Prohibited Jurisdiction, including but not limited
              to: Belarus, Cuba, Iran, North Korea, Russia, Syria, or any other countries restricted
              by the Swiss State Secretariat for Economic Affairs (SECO) or applicable international
              bodies.
            </li>
          </ul>
        </Section>
        ...
        <Section title="5. Relationship with Third-Party Providers">
          ...
          <p>
            <strong className="text-foreground">Independent Contracting:</strong> You are responsible
            for entering into separate, direct agreements with these specialists.
          </p>
          <p>
          ...
          <p>
            <strong className="text-foreground">No Liability:</strong> We assume no responsibility for
            the advice, performance, or omissions of third-party providers.
          </p>
        </Section>

        <Section title="6. Your Right to Use the Services">
          <p>
            We grant you a personal, worldwide, royalty-free, non-assignable, and non-exclusive right
            to access and use the Sites provided as part of the Services. Nothing in these Terms gives
            you the right to use our name, logos, or proprietary rights. You agree not to misuse our
            Services, interfere with our technical delivery systems, or use the Services for any
        ...
        <Section title="7. Fees, Payment Flows, and Dispute Resolution">
          ...
          <p>
            <strong className="text-foreground">Flow of Funds and Revenue Sharing:</strong> Accounting
            models, including mandatory revenue sharing to the Operational Hub and platform commission
            fees, are processed automatically. [Placeholder: Specific payment flow charts and Stripe
            dispute resolution mechanics to be detailed in supplemental documentation].
          </p>
          <p>
        ...
        <Section title="8. Privacy and Cookie Policy">
          ...
          <p>
            We are committed to protecting your personal and corporate data. We collect, process, and
            use your information (including identity verification data and operational metrics) solely
            to perform the Services, improve user experience, and comply with regulatory requirements.
            We do not disclose personally-identifying information to third parties except as necessary
        ...
        <Section title="9. Limitations, Release, and Indemnification">
          <p>
            The Services are Available &ldquo;AS IS&rdquo;. Your access to and use of the Services is
            at your own risk. We disclaim all warranties, whether express or implied, of
            merchantability, fitness for a particular purpose, or non-infringement.
          </p>
          <p>
            By using the Services, you agree that our liability is limited to the maximum extent
            permissible by applicable law. You agree to release us from any claims and damages arising
            out of your disputes with independent third-party service providers. Furthermore, you
            agree to indemnify and hold us harmless from any claims, liabilities, and expenses
            (including attorneys&rsquo; fees) arising out of your violation of these Terms.
          </p>
        </Section>
        ...
        <Section title="10. Termination">
          <p>
            ...
            discontinuing your use of the Services. We may suspend or terminate your account or cease
            providing you with all or part of the Services at any time if we reasonably believe you
            have violated these Terms, create risk or legal exposure for us, or if the provision of
            Services is no longer commercially viable.
          </p>
        </Section>

        <Section title="11. General Provisions">
          <p>
            <strong className="text-foreground">Modifications:</strong> We may revise these Terms from
            time to time. We will notify you 30 days in advance of any material changes. By continuing
            to use the Services, you agree to be bound by the revised Terms.
          </p>
          <p>
          ...
          <p>
            <strong className="text-foreground">Governing Law &amp; Jurisdiction:</strong> These Terms
            are an agreement between you and Achra Ltd, London, UK. These Terms are governed by the
            laws of the United Kingdom. Any disputes arising under or in connection with these Terms
            are subject to the exclusive jurisdiction of the courts of the City of London, UK.
          </p>
          <p>
